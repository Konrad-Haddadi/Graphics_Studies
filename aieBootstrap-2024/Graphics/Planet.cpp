...
Planet::Planet(glm::vec3 _position, float _size, glm::vec4 _color, Planet* _orbiting, float _rotSpeed, bool _hasMoon, bool _hasRing)
	: position(_position), size(_size), rotSpeed(_rotSpeed), color(_color), orbit(_orbiting), hasMoon(_hasMoon), hasRing(_hasRing), moon(nullptr)
{
