...
struct Light
{
	...
	Light(glm::vec3 _position, glm::vec3 _color = glm::vec3(1), float _intensity = 1)
		: direction(_position), color(_color), intensity(_intensity)
	{	}
...
{
public:
	Scene(BaseCamera* _camera, glm::vec2 _windowSize, Light& _globalLight);
	~Scene();
